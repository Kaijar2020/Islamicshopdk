...
public class CheckOutPage extends BasePage {
	...
	//Have Issue
//	public By DISTRICT_FIELD = By.xpath("//span[@class=\"select2-selection__arrow\"]");//this locator found error;
//	public By SELECT_DISTRICT = By.xpath("//span[@class='select2-selection__rendered']");//By.xpath("//span[contains(text(),'Dinajpur')]");
//	public By SELECT_OPTION = By.xpath("//select[@name='billing_state']");
